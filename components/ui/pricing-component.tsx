          ...
          >
            ...
            >
              <div className="mb-6 flex items-center justify-between">
                ...
                <span className="inline-flex text-nowrap shadow-sm items-center rounded-full border border-neutral-200 bg-white/70 px-3 py-1 text-xs font-medium text-neutral-700 backdrop-blur">
                  Most Friendly
                </span>
              </div>
            ...
            >
              <div className="grid grid-cols-2 gap-y-4 gap-x-4">
                {proFeatures.map((feature) => (
                  <div key={feature} className="flex items-center gap-3">
                    <DarkCheckIcon className="w-4 h-4 shrink-0" />
